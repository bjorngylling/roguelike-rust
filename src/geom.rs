...
impl<T: std::clone::Clone> std::ops::Index<(i32, i32)> for Map<T> {
    type Output = T;
...
impl<T: std::clone::Clone> std::ops::IndexMut<(i32, i32)> for Map<T> {
